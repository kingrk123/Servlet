            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                  ...
                  <!--  <li class="menu-title">Icons</li>--><!-- /.menu-title -->
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-maxcdn"></i>Maintenance</a>
                        <ul class="sub-menu children dropdown-menu">
                                ...
                                <div class="main-box">
                                    ...
                                    <div class="main-box-body clearfix">
                                         <%
												...
												PreparedStatement ps=con.prepareStatement("select * from carcategory where srno=?");
												ps.setInt(1,Integer.parseInt(request.getParameter("srNo")));
												ResultSet rs=ps.executeQuery();
												while(rs.next())
												{
										
											%>  
                                    <form action="EditNewCategoryController" method="post">
                                            <div class="form-group">
                                            
                                             <input name="srNo" type="hidden" value="<%=rs.getInt(1) %>">
                                            </div>
                                            <div>
                                                <label for="exampleInputPassword1">Category Name</label>
                                                <input name="categoryname"  value="<%=rs.getString(2) %>" type="text" id="ContentPlaceHolder1_exampleCategory" class="form-control" required="" placeholder="Enter Category Name" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Enter Category Name">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea">Description</label>
                                                <textarea name="description"  type="text" id="ContentPlaceHolder1_exampleDesc" class="form-control" rows="3" required="" placeholder="Enter Category Description" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Enter Category Description"><%=rs.getString(3) %></textarea>
                                            </div><%} %>
                                            <input type="submit" name="ctl00$ContentPlaceHolder1$btnAdd" value="Save" onclick="return Validate();" id="btnAdd" class="btn btn-primary">
