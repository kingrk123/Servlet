             ...
             <div id="wrapper-content">
                                ...
                                <div id="ContentPlaceHolder1_divTable">
                                    ...
                                    <thead>
                                        ...
                                        <th style="text-align: center; width: 61.4px;" class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Premium Customer : activate to sort column ascending">Premium Customer </th>
                                          <th style="text-align: center; width: 51.4px;" class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Customer Username: activate to sort column ascending">Customer Username</th>
				...
				%>                 
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <form action="permission" method="POST" onsubmit="return confirm('Do you want to submit ?')">
                                        ...
                                        <td style="text-align: center;"><a href="DeleteCustomer?id=<%=rs.getInt("sno")%> " onclick="return confirm('Do you really want to delete ?')"><img width="20" height="20" src="images/delete.png"></a></td>
                                    </tr><%i=i+1; }%>
