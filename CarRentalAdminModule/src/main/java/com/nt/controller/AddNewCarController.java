...
public class AddNewCarController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		AddNewCarDto dto=null;
		dto=new AddNewCarDto();
		CustomerService service=null;
		int count=0;
		
		System.out.println("AddNewCarController.doPost()");
	...
	try {
		String result=service.addNewCar(dto);
		System.out.println(result);
		 req.setAttribute("addcar", result);
	}
	catch(Exception e) {
